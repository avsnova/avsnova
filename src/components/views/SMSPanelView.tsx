...
const PRE_CACHED_COUNTRIES = [
  ...
  { id: "2", name: "Kazakhstan", flag: "🇰🇿" },
  { id: "3", name: "China", flag: "🇨🇳" },
  { id: "4", name: "Germany", flag: "🇩🇪" },
  { id: "5", name: "Brazil", flag: "🇧🇷" },
  { id: "6", name: "France", flag: "🇫🇷" },
  { id: "7", name: "Spain", flag: "🇪🇸" },
  { id: "8", name: "Vietnam", flag: "🇻🇳" },
  { id: "21", name: "Egypt", flag: "🇪🇬" },
  { id: "30", name: "South Africa", flag: "🇿🇦" },
  { id: "14", name: "Singapore", flag: "🇸🇬" },
  { id: "13", name: "Israel", flag: "🇮🇱" },
  { id: "86", name: "Italy", flag: "🇮🇹" },
  { id: "132", name: "Japan", flag: "🇯🇵" },
  { id: "66", name: "Pakistan", flag: "🇵🇰" },
  { id: "62", name: "Turkey", flag: "🇹🇷" },
  { id: "150", name: "United Arab Emirates", flag: "🇦🇪" },
  { id: "111", name: "Qatar", flag: "🇶🇦" },
  { id: "29", name: "Saudi Arabia", flag: "🇸🇦" },
  { id: "6_i", name: "Indonesia", flag: "🇮🇩" },
  { id: "18", name: "Iran", flag: "🇮🇷" },
  { id: "47", name: "Iraq", flag: "🇮🇶" },
  { id: "172", name: "Palestine", flag: "🇵🇸" },
  { id: "51", name: "Belarus", flag: "🇧🇾" },
  { id: "15", name: "Poland", flag: "🇵🇱" },
  { id: "136", name: "Afghanistan", flag: "🇦🇫" },
  { id: "85", name: "Albania", flag: "🇦🇱" },
  { id: "58", name: "Algeria", flag: "🇩🇿" },
  { id: "100", name: "Angola", flag: "🇦🇴" },
  { id: "39", name: "Argentina", flag: "🇦🇷" },
  { id: "23", name: "Armenia", flag: "🇦🇲" },
  { id: "45", name: "Australia", flag: "🇦🇺" },
  { id: "123", name: "Austria", flag: "🇦🇹" },
  { id: "34", name: "Azerbaijan", flag: "🇦🇿" },
  { id: "145", name: "Bahrain", flag: "🇧🇭" },
  { id: "25", name: "Bangladesh", flag: "🇧🇩" },
  { id: "82", name: "Belgium", flag: "🇧🇪" },
  { id: "101", name: "Benin", flag: "🇧🇯" },
  { id: "111_b", name: "Bolivia", flag: "🇧🇴" },
  { id: "146", name: "Bosnia and Herzegovina", flag: "🇧🇦" },
  { id: "120", name: "Botswana", flag: "🇧🇼" },
  { id: "84", name: "Bulgaria", flag: "🇧🇬" },
  { id: "119", name: "Burundi", flag: "🇧🇮" },
  { id: "31", name: "Cambodia", flag: "🇰🇭" },
  { id: "41", name: "Cameroon", flag: "🇨🇲" },
  { id: "151", name: "Chad", flag: "🇹🇩" },
  { id: "112", name: "Chile", flag: "🇨🇱" },
  { id: "37", name: "Colombia", flag: "🇨🇴" },
  { id: "113", name: "Costa Rica", flag: "🇨🇷" },
  { id: "106", name: "Croatia", flag: "🇭🇷" },
  { id: "186", name: "Cuba", flag: "🇨🇺" },
  { id: "103", name: "Cyprus", flag: "🇨🇾" },
  { id: "104", name: "Czech Republic", flag: "🇨🇿" },
  { id: "117_d", name: "Denmark", flag: "🇩🇰" },
  { id: "105", name: "Ecuador", flag: "🇪🇨" },
  { id: "121", name: "Finland", flag: "🇫🇮" },
  { id: "62_g", name: "Ghana", flag: "🇬🇭" },
  { id: "129", name: "Greece", flag: "🇬🇷" },
  { id: "114", name: "Guatemala", flag: "🇬🇹" },
  { id: "109", name: "Guinea", flag: "🇬🇳" },
  { id: "137", name: "Haiti", flag: "🇭🇹" },
  { id: "115", name: "Honduras", flag: "🇭🇳" },
  { id: "125", name: "Hong Kong", flag: "🇭🇰" },
  { id: "80", name: "Hungary", flag: "🇭🇺" },
  { id: "108", name: "Ireland", flag: "🇮🇪" },
  { id: "102", name: "Ivory Coast", flag: "🇨🇮" },
  { id: "173", name: "Jamaica", flag: "🇯🇲" },
  { id: "140", name: "Jordan", flag: "🇯🇴" },
  { id: "11", name: "Kyrgyzstan", flag: "🇰🇬" },
  { id: "110", name: "Laos", flag: "🇱🇦" },
  { id: "63", name: "Latvia", flag: "🇱🇻" },
  { id: "135", name: "Lebanon", flag: "🇱🇧" },
  { id: "138", name: "Libya", flag: "🇱🇾" },
  { id: "64", name: "Lithuania", flag: "🇱🇹" },
  { id: "118_m", name: "Madagascar", flag: "🇲🇬" },
  { id: "7", name: "Malaysia", flag: "🇲🇾" },
  { id: "122", name: "Mali", flag: "🇲🇱" },
  { id: "116", name: "Mauritania", flag: "🇲🇷" },
  { id: "54", name: "Mexico", flag: "🇲🇽" },
  { id: "28", name: "Moldova", flag: "🇲🇩" },
  { id: "72", name: "Mongolia", flag: "🇲🇳" },
  { id: "33", name: "Morocco", flag: "🇲🇦" },
  { id: "139", name: "Mozambique", flag: "🇲🇿" },
  { id: "38", name: "Myanmar", flag: "🇲🇲" },
  { id: "126", name: "Nepal", flag: "🇳🇵" },
  { id: "48", name: "Netherlands", flag: "🇳🇱" },
  { id: "46", name: "New Zealand", flag: "🇳🇿" },
  { id: "117_n", name: "Nicaragua", flag: "🇳🇮" },
  { id: "130", name: "Norway", flag: "🇳🇴" },
  { id: "131", name: "Oman", flag: "🇴🇲" },
  { id: "118", name: "Panama", flag: "🇵🇦" },
  { id: "119_p", name: "Paraguay", flag: "🇵🇾" },
  { id: "120_p", name: "Peru", flag: "🇵🇪" },
  { id: "4_p", name: "Philippines", flag: "🇵🇭" },
  { id: "83", name: "Portugal", flag: "🇵🇹" },
  { id: "32", name: "Romania", flag: "🇷🇴" },
  { id: "133", name: "Rwanda", flag: "🇷🇼" },
  { id: "61", name: "Senegal", flag: "🇸🇳" },
  { id: "42", name: "Sri Lanka", flag: "🇱🇰" },
  { id: "40", name: "Sweden", flag: "🇸🇪" },
  { id: "171", name: "Switzerland", flag: "🇨🇭" },
  { id: "142", name: "Syria", flag: "🇸🇾" },
  { id: "132_t", name: "Taiwan", flag: "🇹🇼" },
  { id: "143", name: "Tajikistan", flag: "🇹🇯" },
  { id: "144_t", name: "Tanzania", flag: "🇹🇿" },
  { id: "57", name: "Thailand", flag: "🇹🇭" },
  { id: "112_t", name: "Togo", flag: "🇹🇬" },
  { id: "146_t", name: "Tunisia", flag: "🇹🇳" },
  { id: "149", name: "Uganda", flag: "🇺🇬" },
  { id: "151_u", name: "Uruguay", flag: "🇺🇾" },
  { id: "40_u", name: "Uzbekistan", flag: "🇺🇿" },
  { id: "153_v", name: "Venezuela", flag: "🇻🇪" },
  { id: "155", name: "Yemen", flag: "🇾🇪" },
  { id: "187_u", name: "USA (Virtual)", flag: "🇺🇸" }
];

// 2. Instant-Load Pre-cached Branded 150 Approved Services with Official Logos (Requirement 2, 3 & 4!)
const PRE_CACHED_SERVICES = [
  { id: "wa", name: "WhatsApp", icon: "🟢" },
  { id: "fb", name: "Facebook", icon: "🔵" },
  { id: "ig", name: "Instagram + Threads", icon: "📸" },
  { id: "tg", name: "Telegram", icon: "✈️" },
  { id: "gv", name: "Google Voice", icon: "🌐" }, // Pinned Google Voice (Requirement 4!)
  { id: "ds", name: "Discord", icon: "👾" },
  { id: "tw", name: "Twitter / X", icon: "🐦" },
  { id: "wc", name: "WeChat", icon: "💬" },
  { id: "vi", name: "Viber", icon: "💜" },
  { id: "lg", name: "LINE Messenger", icon: "💬" },
  { id: "kt", name: "KakaoTalk", icon: "💛" },
  { id: "sg", name: "Signal", icon: "💬" },
  { id: "sk", name: "Skype", icon: "🔵" },
  { id: "im", name: "Imo", icon: "💬" },
  { id: "mc", name: "MiChat", icon: "💬" },
  { id: "yl", name: "Yalla", icon: "💬" },
  { id: "gm", name: "GroupMe", icon: "💬" },
  { id: "bd", name: "Badoo", icon: "❤️" },
  { id: "bm", name: "Bumble", icon: "💛" },
  { id: "td", name: "Tinder", icon: "🔥" },
  { id: "hn", name: "Happn", icon: "💙" },
  { id: "td_s", name: "Tind Swipe App", icon: "🔥" },
  { id: "hn_s", name: "Hing Swipe App", icon: "💙" },
  { id: "cm", name: "Cupid Match", icon: "❤️" },
  { id: "fm", name: "Fish Match", icon: "🐟" },
  { id: "mz", name: "Muzz", icon: "💬" },
  { id: "fl", name: "Feeld", icon: "💬" },
  { id: "hr", name: "HER", icon: "💬" },
  { id: "dm", name: "Dil Mil", icon: "💬" },
  { id: "fc", name: "FilipinoCupid", icon: "💬" },
  { id: "ic", name: "InternationalCupid", icon: "💬" },
  { id: "cf", name: "Christian Filipina", icon: "💬" },
  { id: "am", name: "Ashley Madison", icon: "💬" },
  { id: "lv", name: "LOVOO", icon: "💬" },
  { id: "ch", name: "Chispa", icon: "💬" },
  { id: "qq", name: "QuackQuack Dating App", icon: "💬" },
  { id: "jd", name: "JustDating", icon: "💬" },
  { id: "las", name: "LoveAndSeek", icon: "💬" },
  { id: "ma", name: "Match", icon: "💬" },
  { id: "ot_", name: "OurTime", icon: "💬" },
  { id: "pa", name: "Pairs", icon: "💬" },
  { id: "bl", name: "BIGO LIVE", icon: "💬" },
  { id: "lk", name: "Likee", icon: "💬" },
  { id: "kw", name: "Kwai", icon: "💬" },
  { id: "dy", name: "Douyu", icon: "💬" },
  { id: "hy", name: "Huya", icon: "💬" },
  { id: "bb", name: "Bilibili", icon: "💬" },
  { id: "wb", name: "Weibo", icon: "💬" },
  { id: "zh", name: "Zhihu", icon: "💬" },
  { id: "rb", name: "RedBook (Xiaohongshu)", icon: "💬" },
  { id: "ch_", name: "Clubhouse", icon: "💬" },
  { id: "sa", name: "SoulApp", icon: "💬" },
  { id: "wi", name: "Wink", icon: "💬" },
  { id: "lu", name: "LivU", icon: "💬" },
  { id: "mi", name: "MICO", icon: "💬" },
  { id: "tu", name: "TalkU", icon: "💬" },
  { id: "lc", name: "LightChat", icon: "💬" },
  { id: "gc", name: "GoChat", icon: "💬" },
  { id: "tc_", name: "TenChat", icon: "💬" },
  { id: "yy", name: "Yik Yak", icon: "💬" },
  { id: "ps", name: "Periscope", icon: "💬" },
  { id: "he", name: "Hello", icon: "💬" },
  { id: "az", name: "Azar", icon: "💬" },
  { id: "ho", name: "Holla", icon: "💬" },
  { id: "sk_", name: "StreamKar", icon: "💬" },
  { id: "tn", name: "Tango", icon: "💬" },
  { id: "tt", name: "Tantan", icon: "💬" },
  { id: "bl_", name: "Blued", icon: "💬" },
  { id: "mb", name: "Mamba", icon: "💬" },
  { id: "pu", name: "Pure", icon: "💬" },
  { id: "go", name: "Google", icon: "🌐" },
  { id: "ms", name: "Microsoft Outlook", icon: "💻" },
  { id: "ap", name: "Apple", icon: "🍎" },
  { id: "ss", name: "Samsung", icon: "📱" },
  { id: "am_", name: "Amazon", icon: "🛍️" },
  { id: "nf", name: "Netflix", icon: "🍿" },
  { id: "sf", name: "Spotify", icon: "🟢" },
  { id: "tw_", name: "Twitch", icon: "💜" },
  { id: "dr", name: "OpenAI", icon: "✨" },
  { id: "cl", name: "Claude", icon: "✨" },
  { id: "ya", name: "Yahoo", icon: "💜" },
  { id: "ao", name: "AOL", icon: "💻" },
  { id: "pm", name: "Proton Mail", icon: "🔒" },
  { id: "nv", name: "Naver", icon: "🌐" },
  { id: "xi", name: "Xiaomi", icon: "📱" },
  { id: "op", name: "Oppo", icon: "📱" },
  { id: "re", name: "Realme", icon: "📱" },
  { id: "vv", name: "Vivo", icon: "📱" },
  { id: "hu_", name: "Huawei", icon: "📱" },
  { id: "pp", name: "PayPal", icon: "💳" },
  { id: "cb", name: "Coinbase", icon: "🪙" },
  { id: "bi", name: "Binance", icon: "🪙" },
  { id: "rv", name: "Revolut", icon: "💳" },
  { id: "ws", name: "Wise", icon: "💳" },
  { id: "pn", name: "Payoneer", icon: "💳" },
  { id: "ca_", name: "Cash App", icon: "💸" },
  { id: "vm", name: "Venmo", icon: "💸" },
  { id: "mn", name: "Monese", icon: "💳" },
  { id: "ps_", name: "Paysafecard", icon: "💳" },
  { id: "eb", name: "eBay", icon: "🛍️" },
  { id: "py", name: "Paytm", icon: "💸" },
  { id: "ph", name: "PhonePe", icon: "💸" },
  { id: "cr", name: "CRED", icon: "💸" },
  { id: "fc_", name: "FreeCharge", icon: "💸" },
  { id: "mk", name: "MobiKwik", icon: "💸" },
  { id: "ko", name: "Kotak811", icon: "🏦" },
  { id: "mb_", name: "Monobank", icon: "🏦" },
  { id: "sb", name: "Sber", icon: "🏦" },
  { id: "tf", name: "Tinkoff", icon: "🏦" },
  { id: "ab", name: "Alfa Bank", icon: "🏦" },
  { id: "rb_", name: "Raiffeisen Bank", icon: "🏦" },
  { id: "ib", name: "Indian Banks", icon: "🏦" },
  { id: "cw", name: "Crypto Wallets", icon: "🪙" },
  { id: "ok", name: "OKX", icon: "🪙" },
  { id: "by", name: "Bybit", icon: "🪙" },
  { id: "bg", name: "Bitget", icon: "🪙" },
  { id: "mp", name: "MoonPay", icon: "🪙" },
  { id: "cc", name: "Crypto.com", icon: "🪙" },
  { id: "pf", name: "Paxful", icon: "🪙" },
  { id: "li", name: "LinkedIn", icon: "💼" },
  { id: "tc", name: "Truecaller", icon: "📞" },
  { id: "es", name: "Email Services", icon: "📧" },
  { id: "ot", name: "Other Services", icon: "📶" }
];
